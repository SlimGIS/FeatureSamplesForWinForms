...
{
    public partial class GetPointOnALineControl : UserControl
    {
        private MapControl mapContent;

        public GetPointOnALineControl()
        {
            InitializeComponent();
        ...
        private void GetPointOnALineControl_Load(object sender, EventArgs e)
        {
