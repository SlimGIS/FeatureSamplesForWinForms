...
{
    public partial class UseEPSGProjectionControl : UserControl
    {
        private MapControl mapContent;

        public UseEPSGProjectionControl()
        {
            InitializeComponent();
        ...
        private void UseEPSGProjectionControl_Load(object sender, EventArgs e)
        {
