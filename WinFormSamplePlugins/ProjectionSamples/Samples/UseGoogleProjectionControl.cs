...
{
    public partial class UseGoogleProjectionControl : UserControl
    {
        private MapControl mapContent;

        public UseGoogleProjectionControl()
        {
            InitializeComponent();
        ...
        private void UseGoogleProjectionControl_Load(object sender, EventArgs e)
        {
